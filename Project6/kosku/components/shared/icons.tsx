...
export function BedIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function AcIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <rect width="20" height="10" x="2" y="4" rx="2" />
      <path d="M6 14v4" />
      <path d="M10 14v4" />
      <path d="M14 14v4" />
      <path d="M18 14v4" />
...
export function FanIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M12 12c3 0 5 2.5 5 5 0-3-2-5-5-5Z" />
      <path d="M12 12c0 3-2.5 5-5 5 0-3 2-5 5-5Z" />
      <path d="M12 12c-3 0-5-2.5-5-5 0 3 2 5 5 5Z" />
      <circle cx="12" cy="12" r="2" />
    </svg>
  );
}

export function WifiIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function CleanIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M17.5 6.5 19 8l-4 4-1.5-1.5z" />
      <path d="m16 2 6 6" />
      <path d="m19 19 2-2" />
    </svg>
  );
...
export function KitchenIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function RefrigeratorIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ParkingIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function LaundryIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M12 18a2.5 2.5 0 0 0 0-5" />
      <circle cx="7" cy="6" r="1" />
    </svg>
  );
}

export function LivingRoomIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function KeyIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="m21 2-2 2m-1.5 1.5L14 9l-3-3" />
...
export function WhatsAppIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M9.5 9.5c.3.8 1.4 2.3 2.7 3.2 1 .7 1.8.8 2.3.4" />
    </svg>
  );
}
...
export function DoorIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function WardrobeIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function DeskIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function UtensilsIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    ...
    >
      <path d="M18 2v20" />
      <path d="M21 2v6a3 3 0 0 1-3 3 3 3 0 0 1-3-3V2" />
      <path d="m3 2 4 8v12" />
      <path d="m7 2-4 8" />
      <path d="M5 10h4" />
    </svg>
...
export function TrainIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function CigaretteOffIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function WrenchIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function CoinsIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function TrendingDownIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
